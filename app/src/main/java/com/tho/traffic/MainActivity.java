...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickTest(View view) {
        ...
        objIntent.setData(Uri.parse("https://www.youtube.com/watch?v=6wUUjMKogJ0"));
        startActivity(objIntent);//Same sample with recall string from ol version from student*/
    } //click
